...
setup(
    name='lyricsmaster',
    version='2.8.1',
    description="LyricsMaster is a library for downloading lyrics from multiple "
                "lyrics providers. LyricWiki, AzLyrics, Genius, Lyrics007, "
                "MusixMatch and other lyrics provider are available",
    ...
    license="MIT license",
    zip_safe=False,
    keywords='lyricsmaster lyrics LyricWiki Lyrics Wikia Lyrics007 AzLyrics '
             'Genius MusixMatch Tor',
    classifiers=[
